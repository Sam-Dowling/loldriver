...
let root_url = 'https://samdowling.com/loldriver/';
...
function loadActions() {
  ...
  heading_nodes.forEach(function(node){
    link = createEl('a');
    icon = createEl('img');
    icon.src = 'https://samdowling.com/loldriver/icons/link.svg';
  ...
  function copyFeedback(parent) {
    ...
    if(!elem(`.${yanked}`, parent)) {
      ...
      icon.src = 'https://samdowling.com/loldriver/icons/check.svg';
